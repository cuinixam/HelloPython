...
from hello_python.my_app import MyApp

package_name = "hello_python"

app = typer.Typer(name=package_name, help="Playground for Python", no_args_is_help=True, add_completion=False)
